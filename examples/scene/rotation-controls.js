...
/***/ function(module, exports, __webpack_require__) {
  ...
  (function (AFRAME) {
    ...
    (AFRAME.aframeCore || AFRAME).registerComponent('rotation-controls', __webpack_require__(1));
...
/***/ function(module, exports, __webpack_require__) {
  ...
  init: function () {
    ...
    this.deltaRotation = new THREE.Euler();
    this.velocity = new THREE.Euler();
  ...
  update: function () {
    ...
    if (previousData || delta > MAX_DELTA) {
     ...
     if (data.enabled) {
      ...
      el.object3D.rotateX(movementVector.x);
      el.object3D.rotateY(movementVector.y);
      el.object3D.rotateZ(movementVector.z);
